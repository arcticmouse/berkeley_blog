...
div#wrapper {
	...
	margin-right: auto;
	display: block;
    background: url("/wp-content/themes/atahualpa/images/bkgd.png") repeat-x;
...
div.header-image-container {
	...
	{
		echo $bfa_ata['headerimage_height']; 
	}
	?>px; 
	}
<?php } ?>
...
/* padding and bottom margin for parent commment boxes */
.comment_list_inner {
	padding: 10px;
	margin: 0;
}
...
span.comment-meta a:link, 
span.comment-meta a:visited, 
span.comment-meta a:active, 
