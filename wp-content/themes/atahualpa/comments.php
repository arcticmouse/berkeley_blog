...
// Set whether of not we want comments form to appear
global $withtruncation;	// this is an archive, not single post	
global $with_comments_form;			
...
if ( have_comments() ) : ?>
	...
	print '<div class="comment_section_heading"><strong>';
	print '<a name="' . get_the_title() . '"></a>';
...
<?php // If comments are open -- Sara added test to see if form is desired
if ('open' == $post->comment_status && $with_comments_form) : ?>
