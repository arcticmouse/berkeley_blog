...
(function($) {
    ...
    $.maxmegamenu = function(menu, options) {
        ...
        plugin.hidePanel = function(anchor, immediate) {
			...
			//line 47 added YK 09-23/2015 to signal change of state for screen reader
        ...
        plugin.showPanel = function(anchor) {
			...
			//line 145 added YK 09-23/2015 to signal change of state for screen reader
        ...
        var bindClickEvents = function() {
            ...
            $(document).on('keyup touchend', function(event) {
				if (event.which == 9 && !$(event.target).parent('.mega-sub-menu li').length) {
					plugin.closePanels();
                }
            });
