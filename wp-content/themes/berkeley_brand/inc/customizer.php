...
function alienship_customize_register( $wp_customize ) {
	...
	/* BRAND OPTIONS */
/*
	// Add site name format setting
	$wp_customize->add_setting( 'optionsframework_alienship[alienship_site-name-format]', array(
		'default'    => '1',
		'type'       => 'option',
		'transport'  => 'postMessage',
		'capability' => 'edit_theme_options',
	...
	// Add site name format control
	$wp_customize->add_control( 'alienship_site-name-format', array(
		'settings' => 'optionsframework_alienship[alienship_site-name-format]',
		'label'    => __( 'Display site name', 'alienship' ),
		'section'  => 'title_tagline',
		'type'     => 'radio',
		'choices'  => array(
			'1'  => 'One-line with logo',
			'2'  => 'Two-line with logo',
			'3'  => 'Two-line'
		),
	) );
	*/
