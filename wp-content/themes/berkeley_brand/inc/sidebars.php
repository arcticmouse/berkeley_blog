...
function alienship_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Homepage Widgets', 'alienship' ),
		'description'   => __( 'First row of widgets displayed on pages created with the Hero template', 'alienship' ),
		'id'            => 'herowidgets-1',
		'before_widget'  => '<div class="'. bs_count_widgets( 'herowidgets-1' ) .'">', 
	    'after_widget'   => '</div>', 
...
//		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Homepage Widgets 2', 'alienship' ),
		'description'   => __( 'Second row of widgets displayed on pages created with the Hero template', 'alienship' ),
		'id'            => 'herowidgets-2',
		'before_widget'  => '<div class="'. bs_count_widgets( 'herowidgets-2' ) .'">', 
	    'after_widget'   => '</div>', 
//		'before_widget' => '<div class="col-sm-4">',
//		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Homepage Widgets 3', 'alienship' ),
		'description'   => __( 'Third row of widgets displayed on pages created with the Hero template', 'alienship' ),
		'id'            => 'herowidgets-3',
		'before_widget'  => '<div class="'. bs_count_widgets( 'herowidgets-3' ) .'">', 
	    'after_widget'   => '</div>', 
//		'before_widget' => '<div class="col-sm-4">',
//		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer 4', 'alienship' ),
		'description'   => __( 'The fourth footer widget area, displayed below the Footer widget area.', 'alienship' ),
		'id'            => 'footer-4',
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h3 class="widget-title">',
