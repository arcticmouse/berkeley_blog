...
function optionsframework_options() {
  ...
  $options[] = array(
	...
	//Site name format
	$options[] = array(
      'name' => __( 'Site name format', 'alienship' ),
      'desc' => __( '', 'alienship' ),
      'id'   => 'alienship_site-name-format',
      'std'  => '1',
      'type' => 'radio',
	  'options' => array(
          '1' => __( 'One-line with wordmark', 'alienship' ),
          '2' => __( 'Two-line with wordmark', 'alienship' ),
		  '3' => __( 'One-line without wordmark', 'alienship' ),
		  //'4' => __( 'Custom with logo', 'alienship' )
		)
    );
	
	//Site name custom
	 $options[] = array(
      'name' => __( 'Custom site name line 1', 'alienship' ),
      //'desc' => __( 'This setting will be ignored if you do not enable "Custom with logo" above.', 'alienship' ),
      'id'   => 'custom_site_name_line_1',
      'std'  => '',
      'type' => 'text'
    );
	$options[] = array(
      'name' => __( 'Custom site name line 2', 'alienship' ),
      //'desc' => __( 'This setting will be ignored if you do not enable "Custom with logo" above.', 'alienship' ),
	  'desc' => __( 'This setting will be ignored if you do not enable "Two-line with wordmark" above.', 'alienship' ),
      'id'   => 'custom_site_name_line_2',
      'std'  => '',
      'type' => 'text'
    );/*
	$options[] = array(
      'name' => __( 'Custom site name line 3', 'alienship' ),
      'desc' => __( 'This setting will be ignored if you do not enable "Custom with logo" above.', 'alienship' ),
      'id'   => 'custom_site_name_line_3',
      'std'  => '',
      'type' => 'text'
    );*/
  ...
  $options[] = array(
	  'name' => __( 'Post Element Options', 'alienship' ),
	  'desc' => __( 'Options related to the display of Post Elements in page/post editor .', 'alienship' ),
	  'type' => 'info'
	);

  $options[] = array(
	  'name' => __( 'Toggle open first element of a Toggle List', 'alienship' ),
	  'desc' => __( 'Opens first element of a Toggle List open on page load, and closes other elements when clicking on a new element in the list. Default is to have all elements closed on page load, and clicking/opening one element does not close other elements.', 'alienship' ),
	  'id'   => 'alienship_pbsandwich_toggle_list',
	  'std'  => '0',
	  'type' => 'checkbox'
	);
