...
<article role="article" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		<h2 class="entry-title">
			<a class="entry-title zoomable-thumbnail" title="<?php printf( esc_attr__( 'Link to %s', 'alienship' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" href="<?php echo alienship_link_format_helper( 'link' ); ?>">
				<?php the_title(); ?>&nbsp;&rarr;
			</a>
		</h2>
	</header><!-- .entry-header -->
